...
export default function Websites(props) {
  ...
  return (
    <Grid container direction={'column'}>
      ...
      <Grid item container className={classes.rowContainer} direction={'row'} justify={matchesMD ? 'center' : undefined} style={{marginTop: matchesXS ? '1em' : '2em'}}>
        {/**CARDS WITH CONTROLS**/}
        <Hidden mdDown>
          <Grid
            item
      ...
      <Grid item container direction={matchesSM ? 'column' : 'row'} justify={'flex-end'} alignItems={'center'} className={classes.rowContainer}  style={{marginBottom: '15em'}}>
        <Grid item>
          <Grid container direction={'column'}>
            <Grid item>
              <Typography variant={'h4'} align={'center'} gutterBottom>

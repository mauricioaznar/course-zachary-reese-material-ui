  ...
  return (
    <footer className={classes.footer}>
      ...
      <Grid container className={classes.socialContainer} justify={'flex-end'} spacing={2}>
        <Grid item component={'a'} href={'http://www.facebook.com'} rel={'noopener noreferer'} targer={'_blank'}>
          <img alt={'facebook logo'} src={facebook} className={classes.icon}/>
        </Grid>
        <Grid item component={'a'} href={'http://www.twitter.com'} rel={'noopener noreferer'} targer={'_blank'}>
          <img alt={'twitter logo'} src={twitter} className={classes.icon}/>
        </Grid>
        <Grid item component={'a'} href={'http://www.instagram.com'} rel={'noopener noreferer'} targer={'_blank'}>
